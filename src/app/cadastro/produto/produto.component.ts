...
export class ProdutoComponent implements OnInit {
  ...
  salvar() {
    ...
    this.model.valor = this.util.formatarDecimalParaCalculo(this.model.valor);
  ...
  btnAlterarDados(registro) {
    if (registro.dataDesativacao == null || registro.dataDesativacao == "") {
      ...
      this.model = registro;
      this.model.valor = this.util.fortmataMoedaFloatParaString(registro.valor);
  ...
  numericoValor(valor) {
    this.model.valor = this.util.FortmataMoedaStringParaString(valor);
  }
